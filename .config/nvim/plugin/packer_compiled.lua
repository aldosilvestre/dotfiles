...
_G.packer_plugins = {
  ...
  ["FluoroMachine.nvim"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/FluoroMachine.nvim",
  ...
  ["cinnamon.nvim"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/cinnamon.nvim",
  ...
  ["lsp-trouble.nvim"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/lsp-trouble.nvim",
  ...
  ["mason-tool-installer.nvim"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/mason-tool-installer.nvim",
