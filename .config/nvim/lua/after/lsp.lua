local load_attach = function(event)
  ...
  map('K', function() vim.lsp.buf.hover({ border = 'rounded' }) end, "Show Documentation")
  map('<leader>df', require('snacks').picker.diagnostics, "Open [D]iagnostic [F]loat")
  map('<leader>D', require('snacks').picker.lsp_type_definitions, "Type [D]efinition")
